    ...
    <motion.div
      ...
      className={`relative shrink-0 flex flex-col ${
        round
          ...
          : 'items-start justify-between bg-white/[0.05] border border-white/10 backdrop-blur-xl rounded-[12px]'
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden p-4 ${
        round ? 'rounded-full border border-white' : 'rounded-[24px] border border-white/10 bg-white/[0.03]'
      }`}
      style={{
        width: `${baseWidth}px`,
